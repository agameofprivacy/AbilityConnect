...
class FeedProblemTableViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        self.tagsLabel.font = UIFont(name: "HelveticaNeue-Medium", size: 13.0)
        ...
        self.numberOfUpvotesLabel.font = UIFont(name: "HelveticaNeue", size: 13.0)
        ...
        self.upvoteActionLabel.font = UIFont(name: "HelveticaNeue-Light", size: 18.0)
        self.upvoteActionLabel.numberOfLines = 1
        self.upvoteActionLabel.text = "this is upvote action text"
        ...
        self.numberOfCommentsLabel.font = UIFont(name: "HelveticaNeue", size: 13.0)
        ...
        self.commentActionLabel.font = UIFont(name: "HelveticaNeue-Light", size: 18.0)
        self.commentActionLabel.numberOfLines = 1
        self.commentActionLabel.text = "this is comment action text"
        ...
        var upvoteButtonViewVerticalConstraints:Array = NSLayoutConstraint.constraintsWithVisualFormat("V:|-10-[numberOfUpvotesLabel]-6-[upvoteActionLabel]-10-|", options: NSLayoutFormatOptions.AlignAllLeft | NSLayoutFormatOptions.AlignAllRight, metrics: metricsDictionary, views: viewsDictionary)
        ...
        var commentButtonViewVerticalConstraints:Array = NSLayoutConstraint.constraintsWithVisualFormat("V:|-10-[numberOfCommentsLabel]-6-[commentActionLabel]-10-|", options: NSLayoutFormatOptions.AlignAllLeft | NSLayoutFormatOptions.AlignAllRight, metrics: metricsDictionary, views: viewsDictionary)
        ...
        var fullWidthVerticalConstraints:Array = NSLayoutConstraint.constraintsWithVisualFormat("V:[detailLabel]-sideMargin-[tagsLabel]-sideMargin-[upvoteButtonView]-sideMargin-[commentButtonView]-30-|", options: NSLayoutFormatOptions.AlignAllLeft | NSLayoutFormatOptions.AlignAllRight, metrics: metricsDictionary, views: viewsDictionary)
